...
function Feedback({params}) {
  ...
  return (
    <div className='p-10'>
        ...
        <h2 className='text-blue-500 text-lg my-3'>No interview Feedback record found</h2>
        :
        <>
        <h2 className='text-blue-500 text-lg my-3 '>Your overall interview ratimg<strong>7/10</strong></h2>
